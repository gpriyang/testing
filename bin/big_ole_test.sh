...
bzt blazemeter/testing_blaze_demo.yml -o modules.blazemeter.report-name="CircleCI Build blaze demo ${CIRCLE_BUILD_NUM}" -o modules.blazemeter.token=${BLAZZE_API_KEY}
